...
A single readout channel is comprised of three basic functional units, see block diagram of
figure 3.39: i) a charge sensitive amplifier/shaper (PASA); ii) a 10-bit 25MHz low-power ADC;
and iii) a digital circuit that contains a shortening filter for the tail cancellation, baseline subtraction
and zero-suppression circuits, and a multiple-event buffer. A front-end card (FEC) contains 128
channels.
