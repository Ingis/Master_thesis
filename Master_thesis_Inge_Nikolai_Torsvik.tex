...
In this section the result from irradiation at \ac{OCL} will be presented and discussed.
Test of all the PCB boards will be presented first, followed of discussion on SF2 test. The result is presented after type, meaning that two PCb boards with the same \ac{IC} will be presented together.
