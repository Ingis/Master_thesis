...
\begin{figure}[!htbp]
  \centering
  \includegraphics[width=0.5\textwidth, angle =-2.5]{Blue_hall.png}
...
\begin{figure}[!htbp]
  \centering
  \includegraphics[width=0.5\textwidth]{TSL_setup.png}
...
I this section the result from radiation irradiation at \ac{OCL} will be presented and discussed. Every \ac{IC} will be presented for them self.
