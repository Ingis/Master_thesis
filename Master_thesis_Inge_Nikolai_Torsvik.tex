...
and is found to be $\unit{1.14\e{-6}}{\centi\square\meter\per}$
...
Before we could start testing the test boards, we had to prepare the beam. The beam had to be set up by the lab personnel before we could do anything. When the beam was up and running we could control the intensity as we wanted. 
\subsubsection{Beam profile}
When we got the beam up and running we had to do some test to find the center of the beam at DUT location. 
