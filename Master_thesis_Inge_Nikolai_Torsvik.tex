...
The Neutron dosimeter is a \ac{PCB} with a ProASIC FPGA and four 16 Mbit Cypress SRAM chips named CY62167DV30LL-55ZXI. These boards are made by Arild Velure, as part of his master thesis \cite{arild_master}. It is used as a radiation monitor by measuring SEU on the SRAM.

The method for detecting an Single Event Upset (SEU) in a \ac{SRAM} is rather straight
