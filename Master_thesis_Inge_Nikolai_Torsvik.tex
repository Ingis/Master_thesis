...
\begin{table}
 ...
 micro SRAM2 & $8.28\cdot10^{-10}$ & $1.26 *10^{-14}$ & $1.32\cdot10^{-15}$ \\\hline
 \end{tabular}
 \caption{Calculation of Cross section with uncertainty}
...
A breif introduction in how this were tested, and the setup will be explained:
...
For the latchup test on the RCU2, we got a cross section for latchup to be $8.5\cdot10^{-10}\centi\meter²$. But we did a discovery while running the beam. When we received a few latchups, the 1.2 Voltage started to reduce a little, when this happened, we saw a tendency to have less latchups.
We did a separated test on the RCU2, where we reduced the 1.2 Voltage to 1.1 V by changing a resistor on the board. The test showed us that we got a reduction to a cross section of $1.7\cdot10^{-10}\centi\meter²$, which is a reduction of $\sim$5 from previous. 
