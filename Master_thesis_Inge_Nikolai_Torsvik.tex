...
The work presented in this thesis was carried out in order to investigate the radiation tolerance for components used in the design of RCU2. The main focus has been on the RCU2's main FPGA, the SmartFusion2 SoC FPGA, which have been tested of \acl{SEE} like \acl{SEU}, \acl{SET} and \acl{SEL} has been executed on SRAM, logic element and PLL. The other components that have been tested are TPS51200, MIC69302WU, SN74AVCB164245, SN74AVC2T245, QS3VH257, SY89831, ADN2814, MAX3748, INA210 and TLV3011, but then the focus has been on accumulative effects.
...
The RCU2's are going to be mounted in the ALICE TPC detector, where we can expect a fluence rate of 3 $\kilo\hertz/\centi\meter^2$ and a radiation dose of 1-2 kRad. The acquired results is compared up against these numbers, and used to determine if the tested components are cleared to be used on the RCU2.



SRAM memory, Logic element, PLLs
SEU,SET,SEL
