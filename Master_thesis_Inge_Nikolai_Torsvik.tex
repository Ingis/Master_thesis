...
This is the last accelerator in a chain of up to 7 (depending on the particle), where the particles gradually accelerate to higher and higher energies,
...
The ALICE detector comprises several sub-detectors, of which one is the \acf{TP}.\ac{TPC} is the main tracking detector placed in the inner circle of \ac{ALICE}.
...
The detector is made of a large cylindrical field cage, filled with 88 $m^3$ of 90\% Ne gas and 10\% $CO^2$ gas.
...
The cage is divided into 18 sectors, which again is divided into 6 readout partitions.
There is a total of 560 000 pads located on the readout chambers at the \ac{TPC} end caps
